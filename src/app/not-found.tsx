              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-2xl mx-auto">
                <Link href="/">
                  <div className="p-4 bg-white rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-200 min-h-touch">
                    ...
                    <p className="text-sm text-gray-600">View my portfolio homepage</p>
                  </div>
                </Link>
                ...
                <Link href="/about">
                  <div className="p-4 bg-white rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-200 min-h-touch">
                    ...
                    <p className="text-sm text-gray-600">Learn more about me</p>
                  </div>
                </Link>
                
                <Link href="/projects">
                  <div className="p-4 bg-white rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-200 min-h-touch">
                    <h4 className="font-medium text-gray-900 mb-1">Projects</h4>
                    <p className="text-sm text-gray-600">Browse my work</p>
                  </div>
                </Link>
              </div>
            </div>
