...
import { ExternalLink, Github, Calendar, Tag, Code, Eye, ArrowLeft } from 'lucide-react'
                ...
                {images.map((image, index) => (
                  <div
                    ...
                    className={`aspect-video bg-gray-200 rounded-lg cursor-pointer min-h-touch transition-all duration-200 ${
                      index === selectedImage ? 'ring-2 ring-blue-500' : 'hover:ring-2 hover:ring-gray-300'
                    }`}
                    onClick={() => setSelectedImage(index)}
                  >
                    <div className="w-full h-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
                      <div className="text-white text-center">
                        <div className="text-sm font-bold">Image {index + 1}</div>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <div className="relative max-w-4xl max-h-full">
            <div className="relative aspect-video bg-gray-200 rounded-lg overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
                <div className="text-white text-center">
                  <div className="text-2xl font-bold mb-2">{project.title}</div>
                  <div className="text-sm opacity-90">Image {selectedImage + 1} of {images.length}</div>
                </div>
              </div>
            </div>
